import { Schema, model, models, Document, Types, CallbackWithoutResultAndOptionalError } from 'mongoose';
...
BookingSchema.pre('save', async function (next: CallbackWithoutResultAndOptionalError) {
